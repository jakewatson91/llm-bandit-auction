...
MODEL_CATALOG = {
    ...
    "llama-3.3-70b-versatile": {
        "provider": "groq",
        "market_model": False, "benchmark_model": False, "is_classifier": False, "is_judge": True,
    ...
    "llama-3.1-8b-instant": {
        "provider": "groq",
        "market_model": False, "benchmark_model": False, "is_classifier": False,
        "cost_in": 0.05 / 1e6, "cost_out": 0.08 / 1e6, "tps": 840, "base_latency": 0.2
    },
    "mistral-7b-instruct": {
        "provider": "openrouter",
        "model_id": "mistralai/mistral-7b-instruct:free",
        "market_model": False, "is_classifier": True, "is_judge": False,
        "cost_in": 0.05 / 1e6,"cost_out": 0.08 / 1e6, "tps": 500, "base_latency": 0.3
    },
    "google/gemini-2.0-flash-exp:free": {
        "provider": "openrouter",
        "market_model": False, "benchmark_model": False, "is_classifier": True,
        "cost_in": 0.10 / 1e6, "cost_out": 0.40 / 1e6, "base_latency": 0.3, "tps": 200
    },
    "openai/gpt-oss-20b": {
        "provider": "groq",
    ...
    "gemini-2.5-flash": {
        "provider": "gemini", 
        "market_model": False, "benchmark_model": False, "is_judge": False,
